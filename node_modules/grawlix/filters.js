...
const GrawlixFilter = function(word, regex, options) {
  ...
  this.configure = function(opts) {
    ...
    if (_.has(opts, "priority") && _.isNumber(opts.priority)) {
      ...
      _.has(opts, "minPriority") &&
      _.isNumber(opts.minPriority) &&
...
var toGrawlixFilter = function(obj) {
  ...
  return new GrawlixFilter(obj.word, obj.pattern, obj);
};
 ...
 */
var Filters = [
  /*These filters are not default*/
  //racism
  new GrawlixFilter("nigger", /n[i1]gg/i, {
    expandable: true
  }),
  /*These filters are default*/
