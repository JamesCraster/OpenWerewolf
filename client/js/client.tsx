...
let notificationSound: HTMLAudioElement = new Audio(
  "assets/sounds/162464__kastenfrosch__message.mp3",
);
notificationSound.volume = 0.2;
let newPlayerSound: HTMLAudioElement = new Audio(
  "assets/sounds/162476__kastenfrosch__gotitem.mp3",
);
newPlayerSound.volume = 0.1;
let lostPlayerSound: HTMLAudioElement = new Audio(
  "assets/sounds/162465__kastenfrosch__lostitem.mp3",
);
lostPlayerSound.volume = 0.1;
...
const playerTexture = PIXI.Texture.fromImage(
  "assets/sprites/swordplayerbreathing/sprite_0.png",
);
const playerTexture2 = PIXI.Texture.fromImage(
  "assets/sprites/swordplayerbreathing/sprite_1.png",
);
const playerTextureSelected = PIXI.Texture.fromImage(
  "assets/sprites/swordplayerbreathing/sprite_0_selected.png",
);
